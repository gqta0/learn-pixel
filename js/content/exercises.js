...
/* --- Phần 1 --- */
{tr:'terraria',p:12,size:16,t:'Khối đá và ba biến thể',time:'60 phút',frames:4, art:'terrablock', buoc:'buocterra',
 goal:'Khối nền tảng, lặp kín màn hình mà mắt không thấy hoa văn lặp.',
 steps:['Chọn dải 4 màu của đá. Terraria khác Minecraft ở chỗ khối <b>có hướng sáng thật</b>, nên dải này được phép rộng hơn.',
        'Dựng <b>bậc theo chiều cao</b>: hai hàng trên cùng bậc sáng nhất, phần giữa bậc 2 rồi bậc 1, ba hàng đáy bậc tối nhất. Dùng <b>Chữ nhật (U)</b> tô từng dải cho nhanh.',
        'Rắc nhiễu <b>phá bậc</b>: dọc mỗi ranh giới giữa hai bậc, đổi chỗ vài pixel qua lại để đường chuyển không thẳng băng.',
        'Hạ tối <b>mép đáy</b>: hàng cuối tối hẳn, hàng áp cuối tối lỗ chỗ. Đây là thứ làm các khối xếp chồng dính vào nhau.',
        'Ba biến thể còn lại: chép khung 1 rồi chỉ đổi vị trí đám nhiễu, giữ nguyên bậc. Bốn khối phải là <b>một vật liệu</b>.'],
...
{tr:'terraria',p:12,size:16,t:'Khối đất có cỏ phủ',time:'60 phút',frames:3, art:'terraghep', buoc:'buoccoterra',
 goal:'Khối hai vật liệu — chỗ người mới hay để lộ mối nối nhất.',
 steps:['Dựng khối <b>đất</b> hoàn chỉnh theo bốn bước bài khối đá, dùng dải nâu.',
        'Chọn sắc cỏ giữa, phủ một viền ngang <b>2 pixel</b> sát mép trên. Tạm để phẳng.',
        'Bẻ viền thành <b>răng cưa</b> 2 đến 4 pixel tuỳ cột. Không được là một đường thẳng.',
        'Rám <b>ba sắc cỏ</b> vào viền: sắc tối ở chỗ giáp đất, sắc sáng ở mép trên.',
        'Khung 2 và 3: cỏ phủ khi có khối bên trái, và khi có khối bên phải — viền cỏ phải chạy vòng xuống cạnh đó.'],
...
{tr:'terraria',p:12,size:16,t:'Quặng nhúng trong đá',time:'50 phút',frames:3, art:'terraore', buoc:'buocquangterra',
 goal:'Phần thưởng của người chơi — bắt mắt từ xa mà vẫn thuộc về khối đá.',
 steps:['Mở lại khối đá đã xong ở bài trước. Nền đá <b>không sửa gì nữa</b>.',
        'Chấm <b>tâm 3–4 cụm</b> bằng màu chói tạm. Đặt lệch nhau, tránh sát mép.',
        'Đắp cụm quặng: mỗi cụm 3 pixel hình chữ L quanh tâm, dùng hai sắc giữa của dải quặng. Xoá màu tạm.',
        'Chấm sắc <b>sáng nhất</b> lên đỉnh mỗi cụm — Terraria có hướng sáng nên điểm sáng luôn ở phía trên.',
        'Ba khung: vàng, đồng, và một loại tự chọn. Cả ba dùng chung đúng nền đá.'],
...
{tr:'mc',p:21,size:16,t:'Lát liền mạch: phép thử duy nhất đáng tin',time:'45 phút', art:'mclat', buoc:'buocda',
 goal:'Một texture chỉ đúng khi lát ra không thấy mối nối.',
 steps:['Chọn <b>bốn sắc độ</b> của đá. Thẻ Màu → <b>Dải màu</b>: một xám ngả xanh, số bậc 5, lệch tông 12°, bấm <b>Đưa dải vào bảng màu</b>. Bỏ bậc sáng nhất, còn lại bốn. Bậc thứ hai từ trái là <b>màu nền</b>.',
        'Chọn màu nền, lấy <b>Tô loang (G)</b>, bấm một cái vào canvas. Cả ô 16×16 giờ là một màu phẳng.',
        'Chọn <b>bậc tối</b>, bút cỡ 1. Rắc chừng <b>40–45 pixel</b> thành cụm 2–3 ô dính nhau, rải khắp ô. Đừng rắc thành hàng, đừng rắc dày ở mép.',
        'Chọn <b>bậc sáng</b>, rắc chừng <b>35–40 pixel</b> vào những khoảng trống giữa các cụm tối. Nhìn tổng thể phải thấy tối và sáng cài răng lược, không bên nào thành mảng lớn.',
        'Chọn <b>bậc sáng nhất</b>, chỉ chấm <b>10–15 pixel</b>, thật thưa, không chấm hai cái cạnh nhau. Đây là bậc dễ làm hỏng texture nhất.',
        'Bật <b>▩ Lặp 3×3</b> trong ⋯ Thêm. Soi hai thứ: có <b>đường kẻ</b> ở mối nối không, và có <b>chấm nào lặp thành lưới</b> không. Có thì quay lại bước 5 bớt chấm sáng, hoặc sửa pixel ở mép.'],
...
/* --- Phần 1 --- */
{tr:'mc',p:22,size:16,t:'Đá, đá cuội, gạch',time:'60 phút',frames:3, art:'mcda', buoc:'buocgach',
 goal:'Ba vật liệu cùng gốc, khác nhau ở kích cỡ hạt chứ không ở màu.',
 steps:['Khung 1 <b>đá</b>: làm lại đúng sáu bước bài trước. Cụm nhiễu 1–2 pixel.',
        'Khung 2 <b>đá cuội</b>: cũng sáu bước ấy, cùng bảng màu, chỉ đổi <b>cỡ cụm</b> lên 3–4 pixel dính nhau. Không đổi màu, không tăng tương phản.',
        'Khung 3 <b>gạch</b>, bước 1: tô loang cả ô bằng màu nền gạch.',
        'Gạch bước 2: chọn bậc tối nhất, dùng <b>Đường thẳng (L)</b> kẻ mạch ngang ở y = 0, 4, 8, 12. Bốn hàng viên, mỗi viên cao 4 pixel.',
        'Gạch bước 3: kẻ mạch dọc. Hàng 1 và 3 kẻ ở x = 0 và 8; hàng 2 và 4 kẻ ở x = 4 và 12 — <b>so le nửa viên</b>.',
        'Gạch bước 4: rám nhiễu nhẹ vào lòng từng viên, 3–4 pixel mỗi viên, để viên nào cũng khác viên nào một chút.',
        'Lát cả ba ở 3×3. Riêng gạch kiểm thêm: nhịp so le có chạy tiếp sang ô bên cạnh không.'],
...
{tr:'mc',p:22,size:16,t:'Đất và cỏ: ba mặt của một khối',time:'70 phút',frames:3, art:'mcco', buoc:'buocco',
 goal:'Khối đầu tiên cần nhiều hơn một texture.',
 steps:['Khung 2 trước, vì nó khó nhất. Dựng <b>mặt bên</b>: một khối đất hoàn chỉnh theo sáu bước bài “Lát liền mạch”, dùng bốn sắc nâu.',
        'Vẫn khung 2: chọn sắc cỏ giữa, dùng <b>Chữ nhật (U)</b> phủ một dải ngang <b>3 pixel</b> sát mép trên. Tạm để phẳng đã.',
        'Bẻ mép dải cỏ thành <b>răng cưa</b>: mỗi cột sâu 2 đến 5 pixel, đổi thất thường. Bút cỡ 1, thêm bớt từng pixel. Đây là bước quyết định khối nhìn giả hay thật.',
        'Rám <b>bốn sắc cỏ</b> vào trong dải, đậm nhạt xen kẽ, đừng để một sắc thành mảng.',
        'Khung 1 <b>mặt trên</b>: sáu bước như đá nhưng dùng bốn sắc cỏ, nhiễu mịn, không hướng.',
        'Khung 3 <b>mặt dưới</b>: chép lại đúng khối đất ở bước 1, không sửa gì.',
        'Kiểm mặt bên ở 3×3: mép trái và mép phải phải nối được, kể cả phần răng cưa.'],
...
{tr:'mc',p:22,size:16,t:'Gỗ: vỏ, mặt cắt, ván',time:'70 phút',frames:3, art:'mcgo', buoc:'buocgo',
 goal:'Vật liệu duy nhất có hướng — và hướng ấy phải nhất quán.',
 steps:['Chọn bốn sắc vỏ cây: thẻ Màu → <b>Dải màu</b>, lệch tông 10°, rồi bỏ bậc sáng nhất.',
        'Khung 1 <b>vỏ thân</b>, bước đầu: chọn màu nền, <b>Tô loang (G)</b> một cái là kín ô.',
        'Chia <b>theo cột</b>: mỗi cột dọc lấy một tông trong bốn sắc, cột cạnh nhau chênh nhau nhiều nhất một bậc. Dùng <b>Đường thẳng (L)</b> kéo dọc cho nhanh. Đây là chỗ sinh ra thớ gỗ.',
        'Rắc nhiễu <b>đứt quãng dọc theo thớ</b>: mỗi đoạn 2–3 pixel, không kéo hết cột. Kẻ sọc liền mạch sẽ ra vải kẻ chứ không ra gỗ.',
        'Khung 3 <b>ván</b>: y hệt bốn bước trên nhưng chia <b>theo hàng</b>. Xong kẻ mạch ngang ở giữa ô và ở hàng cuối, rồi kẻ mối nối dọc so le giữa hai hàng ván.',
        'Khung 2 <b>mặt cắt</b>: chấm tâm hơi lệch khỏi chính giữa, vẽ 3–4 vòng năm bằng <b>Ê-líp (O)</b> rỗng, viền ngoài cùng là màu vỏ.',
...
{tr:'mc',p:22,size:16,t:'Quặng nhúng trong đá',time:'60 phút',frames:3, art:'mcquang', buoc:'buocquang',
 goal:'Thứ người chơi tìm cả buổi — phải đọc được từ xa.',
 steps:['Bước này đã xong từ bài trước: mở lại khối đá hoàn chỉnh, hoặc dựng lại theo sáu bước. <b>Không sửa gì vào nền đá nữa.</b>',
        'Chấm <b>tâm của 3 cụm</b> bằng một màu chói tạm (cam chẳng hạn) để nhìn rõ bố cục. Đặt lệch nhau, đừng thẳng hàng, đừng sát mép quá 2 pixel.',
        'Đổi sang sắc quặng sáng, đắp <b>lõi cụm</b> quanh mỗi tâm: 4–8 pixel, tròn méo chứ không vuông. Xoá màu tạm đi.',
        'Viền <b>rìa cụm</b> bằng sắc quặng tối nhất, dày 1 pixel. Không có rìa thì cụm dính vào đá.',
        'Ba khung: sắt (nhạt, ngả hồng), vàng (ấm), kim cương (lơ xanh). Cả ba dùng chung đúng nền đá và đúng ba vị trí cụm.',
        'Nheo mắt nhìn ở 3×3. Còn thấy cụm không? Không thấy thì <b>làm cụm to lên</b>, đừng làm sáng lên.'],
...
export function buildExercises(){
  ...
  PHASES.forEach((ph,pi)=>{
    ...
    list.forEach(ex=>{
      ...
      if(ex.buoc && DEMOS[ex.buoc]){          // dải hình từng bước, đặt ngay dưới danh sách thao tác
        const ol=wrap.querySelector('ol');
        const lab=document.createElement('p'); lab.className='exart'; lab.textContent='Làm từng bước';
        ol.after(lab);
        lab.after(renderDemo(ex.buoc, true));
      }
